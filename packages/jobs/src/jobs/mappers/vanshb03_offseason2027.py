"""
vanshb03/Summer2027-Internships OFFSEASON_README (dev branch) — markdown pipe table.
Same format as the summer README; row_type = "offseason".
"""
...
class Vanshb03Offseason2027Mapper(MapperAbstract):
    SOURCE_ID = "vanshb03_offseason2027"
    SOURCE_URL = "https://raw.githubusercontent.com/vanshb03/Summer2027-Internships/dev/OFFSEASON_README.md"
    CONFIG = {
