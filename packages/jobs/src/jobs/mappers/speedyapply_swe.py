"""
speedyapply/2027-SWE-College-Jobs README.md — three HTML-rich tables (FAANG+, Quant, Other).
...
class SpeedyApplySWEMapper(MapperAbstract):
    ...
    SOURCE_URL = "https://raw.githubusercontent.com/speedyapply/2027-SWE-College-Jobs/main/README.md"
    CONFIG = {
