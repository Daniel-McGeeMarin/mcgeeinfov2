...
def _education(body, edu: dict):
    ...
    pp1 = _pPr(p1)
    _e(pp1, "w:pBdr")
    _e(_e(pp1, "w:tabs"), "w:tab", {"w:val": "right", "w:leader": "none", "w:pos": "11040"})
    ...
    pp2 = _pPr(p2)
    _e(pp2, "w:pBdr")
    _e(_e(pp2, "w:tabs"), "w:tab", {"w:val": "right", "w:leader": "none", "w:pos": "11040"})
...
def _experience(body, exp: dict):
    ...
    pp = _pPr(p)
    _e(pp, "w:pBdr")
    _e(_e(pp, "w:tabs"), "w:tab", {"w:val": "right", "w:leader": "none", "w:pos": "11040"})
    _e(pp, "w:spacing", {"w:before": "100"})
    _e(pp, "w:ind", {"w:firstLine": "0", "w:left": "12"})
    rp = _e(pp, "w:rPr")
    _e(rp, "w:b"); _e(rp, "w:bCs")
